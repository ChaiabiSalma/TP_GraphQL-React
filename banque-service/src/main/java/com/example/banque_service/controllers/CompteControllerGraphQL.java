...
public class CompteControllerGraphQL {
    ...
    public String deleteCompte(@Argument Long id) {
        ...
        // Supprimer d'abord toutes les transactions associées au compte
        transactionRepository.deleteByCompteId(id); // Assurez-vous d'avoir cette méthode dans votre TransactionRepository

        // Supprimer le compte
        compteRepository.deleteById(id);

        return String.format("Compte %s et ses transactions ont été supprimés avec succès", id);
    }
